...
export default function Home() {
  ...
  return (
    <>
      <section className="relative h-[55vh] flex items-center justify-center text-center text-blue overflow-hidden" dir={dir}>
        <Image
        ...
        <div className="relative z-20 container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-headline font-bold mb-4 mt-12 drop-shadow-lg">{translations.home.title}</h1>
